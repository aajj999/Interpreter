...
instance Print (AbsExp.Program' a) where
  prt i = \case
    AbsExp.Program _ globals topdefs -> prPrec i 0 (concatD [prt 0 globals, prt 0 topdefs])

instance Print (AbsExp.Global' a) where
  prt i = \case
    AbsExp.GlobalDef _ type_ id_ expr -> prPrec i 0 (concatD [doc (showString "global"), prt 0 type_, prt 0 id_, doc (showString "="), prt 0 expr, doc (showString ";")])
...
instance Print (AbsExp.Arg' a) where
  prt i = \case
    ...
    AbsExp.InArg _ type_ id_ -> prPrec i 0 (concatD [doc (showString "in"), prt 0 type_, prt 0 id_])
    AbsExp.OutArg _ type_ id_ -> prPrec i 0 (concatD [doc (showString "out"), prt 0 type_, prt 0 id_])
...
instance Print (AbsExp.Stmt' a) where
  prt i = \case
    ...
    AbsExp.Ass _ id_ expr -> prPrec i 0 (concatD [prt 0 id_, doc (showString "="), prt 0 expr, doc (showString ";")])
    AbsExp.Incr _ id_ -> prPrec i 0 (concatD [prt 0 id_, doc (showString "++"), doc (showString ";")])
    AbsExp.Decr _ id_ -> prPrec i 0 (concatD [prt 0 id_, doc (showString "--"), doc (showString ";")])
    ...
    AbsExp.Print _ expr -> prPrec i 0 (concatD [doc (showString "print"), prt 0 expr, doc (showString ";")])
...
instance Print (AbsExp.Type' a) where
  prt i = \case
    ...
    AbsExp.Bool _ -> prPrec i 0 (concatD [doc (showString "bool")])
...
instance Print (AbsExp.Expr' a) where
  prt i = \case
    AbsExp.EVar _ id_ -> prPrec i 6 (concatD [prt 0 id_])
