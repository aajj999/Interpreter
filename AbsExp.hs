...
data Program' a = Program a [Global' a] [TopDef' a]
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type Global = Global' BNFC'Position
data Global' a = GlobalDef a (Type' a) Ident (Expr' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
data Arg' a
    = Arg a (Type' a) Ident
    | InArg a (Type' a) Ident
    | OutArg a (Type' a) Ident
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
instance HasPosition Global where
  hasPosition = \case
    GlobalDef p _ _ _ -> p
